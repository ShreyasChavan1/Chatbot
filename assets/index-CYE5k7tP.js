 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function za(t,e,n){return`firebase:${t}:${e}:${n}`}class Ii{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=za(this.userKey,i.apiKey,s),this.fullPersistenceKey=za("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?pn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new Ii(mn(Wm),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||mn(Wm);const o=za(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const g=pn._fromJSON(e,f);h!==s&&(l=g),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new Ii(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new Ii(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O1(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function D1(t){const e=As(Is(t)).link,n=e?As(Is(e)).deep_link_id:null,r=As(Is(t)).deep_link_id;return(r?As(Is(r)).link:null)||r||n||e||t}class Bd{constructor(e){var n,r,i,s,o,l;const u=As(Is(e)),h=(n=u.apiKey)!==null&&n!==void 0?n:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,g=O1((i=u.mode)!==null&&i!==void 0?i:null);G(h&&f&&g,"argument-error"),this.apiKey=h,this.operation=g,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=D1(e);try{return new Bd(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BC="__/auth/handler",jC="emulator/auth/handler",zC=encodeURIComponent("fac");async function eg(t,e,n,r,i,s){G(t.config.authDomain,t,"auth-domain-config-required"),G(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:qi,eventId:i};if(e instanceof Z_){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",PT(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))o[f]=g}if(e instanceof Oo){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${zC}=${encodeURIComponent(u)}`:"";return`${WC(t)}?${ko(l).slice(1)}${h}`}function WC({config:t}){return t.emulator?Md(t,jC):`https://${t.authDomain}/${BC}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var kr,pE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,m){function v(){}v.prototype=m.prototype,_.D=m.prototype,_.prototype=new v,_.prototype.constructor=_,_.C=function(w,C,k){for(var A=Array(arguments.length-2),dt=2;dt<arguments.length;dt++)A[dt-2]=arguments[dt];return m.prototype[C].apply(w,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(_,m,v){v||(v=0);var w=Array(16);if(typeof m=="string")for(var C=0;16>C;++C)w[C]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(C=0;16>C;++C)w[C]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=_.g[0],v=_.g[1],C=_.g[2];var k=_.g[3],A=m+(k^v&(C^k))+w[0]+3614090360&4294967295;m=v+(A<<7&4294967295|A>>>25),A=k+(C^m&(v^C))+w[1]+3905402710&4294967295,k=m+(A<<12&4294967295|A>>>20),A=C+(v^k&(m^v))+w[2]+606105819&4294967295,C=k+(A<<17&4294967295|A>>>15),A=v+(m^C&(k^m))+w[3]+3250441966&4294967295,v=C+(A<<22&4294967295|A>>>10),A=m+(k^v&(C^k))+w[4]+4118548399&4294967295,m=v+(A<<7&4294967295|A>>>25),A=k+(C^m&(v^C))+w[5]+1200080426&4294967295,k=m+(A<<12&4294967295|A>>>20),A=C+(v^k&(m^v))+w[6]+2821735955&4294967295,C=k+(A<<17&4294967295|A>>>15),A=v+(m^C&(k^m))+w[7]+4249261313&4294967295,v=C+(A<<22&4294967295|A>>>10),A=m+(k^v&(C^k))+w[8]+1770035416&4294967295,m=v+(A<<7&4294967295|A>>>25),A=k+(C^m&(v^C))+w[9]+2336552879&4294967295,k=m+(A<<12&4294967295|A>>>20),A=C+(v^k&(m^v))+w[10]+4294925233&4294967295,C=k+(A<<17&4294967295|A>>>15),A=v+(m^C&(k^m))+w[11]+2304563134&4294967295,v=C+(A<<22&4294967295|A>>>10),A=m+(k^v&(C^k))+w[12]+1804603682&4294967295,m=v+(A<<7&4294967295|A>>>25),A=k+(C^m&(v^C))+w[13]+4254626195&4294967295,k=m+(A<<12&4294967295|A>>>20),A=C+(v^k&(m^v))+w[14]+2792965006&4294967295,C=k+(A<<17&4294967295|A>>>15),A=v+(m^C&(k^m))+w[15]+1236535329&4294967295,v=C+(A<<22&4294967295|A>>>10),A=m+(C^k&(v^C))+w[1]+4129170786&4294967295,m=v+(A<<5&4294967295|A>>>27),A=k+(v^C&(m^v))+w[6]+3225465664&4294967295,k=m+(A<<9&4294967295|A>>>23),A=C+(m^v&(k^m))+w[11]+643717713&4294967295,C=k+(A<<14&4294967295|A>>>18),A=v+(k^m&(C^k))+w[0]+3921069994&4294967295,v=C+(A<<20&4294967295|A>>>12),A=m+(C^k&(v^C))+w[5]+3593408605&4294967295,m=v+(A<<5&4294967295|A>>>27),A=k+(v^C&(m^v))+w[10]+38016083&4294967295,k=m+(A<<9&4294967295|A>>>23),A=C+(m^v&(k^m))+w[15]+3634488961&4294967295,C=k+(A<<14&4294967295|A>>>18),A=v+(k^m&(C^k))+w[4]+3889429448&4294967295,v=C+(A<<20&4294967295|A>>>12),A=m+(C^k&(v^C))+w[9]+568446438&4294967295,m=v+(A<<5&4294967295|A>>>27),A=k+(v^C&(m^v))+w[14]+3275163606&4294967295,k=m+(A<<9&4294967295|A>>>23),A=C+(m^v&(k^m))+w[3]+4107603335&4294967295,C=k+(A<<14&4294967295|A>>>18),A=v+(k^m&(C^k))+w[8]+1163531501&4294967295,v=C+(A<<20&4294967295|A>>>12),A=m+(C^k&(v^C))+w[13]+2850285829&4294967295,m=v+(A<<5&4294967295|A>>>27),A=k+(v^C&(m^v))+w[2]+4243563512&4294967295,k=m+(A<<9&4294967295|A>>>23),A=C+(m^v&(k^m))+w[7]+1735328473&4294967295,C=k+(A<<14&4294967295|A>>>18),A=v+(k^m&(C^k))+w[12]+2368359562&4294967295,v=C+(A<<20&4294967295|A>>>12),A=m+(v^C^k)+w[5]+4294588738&4294967295,m=v+(A<<4&4294967295|A>>>28),A=k+(m^v^C)+w[8]+2272392833&4294967295,k=m+(A<<11&4294967295|A>>>21),A=C+(k^m^v)+w[11]+1839030562&4294967295,C=k+(A<<16&4294967295|A>>>16),A=v+(C^k^m)+w[14]+4259657740&4294967295,v=C+(A<<23&4294967295|A>>>9),A=m+(v^C^k)+w[1]+2763975236&4294967295,m=v+(A<<4&4294967295|A>>>28),A=k+(m^v^C)+w[4]+1272893353&4294967295,k=m+(A<<11&4294967295|A>>>21),A=C+(k^m^v)+w[7]+4139469664&4294967295,C=k+(A<<16&4294967295|A>>>16),A=v+(C^k^m)+w[10]+3200236656&4294967295,v=C+(A<<23&4294967295|A>>>9),A=m+(v^C^k)+w[13]+681279174&4294967295,m=v+(A<<4&4294967295|A>>>28),A=k+(m^v^C)+w[0]+3936430074&4294967295,k=m+(A<<11&4294967295|A>>>21),A=C+(k^m^v)+w[3]+3572445317&4294967295,C=k+(A<<16&4294967295|A>>>16),A=v+(C^k^m)+w[6]+76029189&4294967295,v=C+(A<<23&4294967295|A>>>9),A=m+(v^C^k)+w[9]+3654602809&4294967295,m=v+(A<<4&4294967295|A>>>28),A=k+(m^v^C)+w[12]+3873151461&4294967295,k=m+(A<<11&4294967295|A>>>21),A=C+(k^m^v)+w[15]+530742520&4294967295,C=k+(A<<16&4294967295|A>>>16),A=v+(C^k^m)+w[2]+3299628645&4294967295,v=C+(A<<23&4294967295|A>>>9),A=m+(C^(v|~k))+w[0]+4096336452&4294967295,m=v+(A<<6&4294967295|A>>>26),A=k+(v^(m|~C))+w[7]+1126891415&4294967295,k=m+(A<<10&4294967295|A>>>22),A=C+(m^(k|~v))+w[14]+2878612391&4294967295,C=k+(A<<15&4294967295|A>>>17),A=v+(k^(C|~m))+w[5]+4237533241&4294967295,v=C+(A<<21&4294967295|A>>>11),A=m+(C^(v|~k))+w[12]+1700485571&4294967295,m=v+(A<<6&4294967295|A>>>26),A=k+(v^(m|~C))+w[3]+2399980690&4294967295,k=m+(A<<10&4294967295|A>>>22),A=C+(m^(k|~v))+w[10]+4293915773&4294967295,C=k+(A<<15&4294967295|A>>>17),A=v+(k^(C|~m))+w[1]+2240044497&4294967295,v=C+(A<<21&4294967295|A>>>11),A=m+(C^(v|~k))+w[8]+1873313359&4294967295,m=v+(A<<6&4294967295|A>>>26),A=k+(v^(m|~C))+w[15]+4264355552&4294967295,k=m+(A<<10&4294967295|A>>>22),A=C+(m^(k|~v))+w[6]+2734768916&4294967295,C=k+(A<<15&4294967295|A>>>17),A=v+(k^(C|~m))+w[13]+1309151649&4294967295,v=C+(A<<21&4294967295|A>>>11),A=m+(C^(v|~k))+w[4]+4149444226&4294967295,m=v+(A<<6&4294967295|A>>>26),A=k+(v^(m|~C))+w[11]+3174756917&4294967295,k=m+(A<<10&4294967295|A>>>22),A=C+(m^(k|~v))+w[2]+718787259&4294967295,C=k+(A<<15&4294967295|A>>>17),A=v+(k^(C|~m))+w[9]+3951481745&4294967295,_.g[0]=_.g[0]+m&4294967295,_.g[1]=_.g[1]+(C+(A<<21&4294967295|A>>>11))&4294967295,_.g[2]=_.g[2]+C&4294967295,_.g[3]=_.g[3]+k&4294967295}r.prototype.u=function(_,m){m===void 0&&(m=_.length);for(var v=m-this.blockSize,w=this.B,C=this.h,k=0;k<m;){if(C==0)for(;k<=v;)i(this,_,k),k+=this.blockSize;if(typeof _=="string"){for(;k<m;)if(w[C++]=_.charCodeAt(k++),C==this.blockSize){i(this,w),C=0;break}}else for(;k<m;)if(w[C++]=_[k++],C==this.blockSize){i(this,w),C=0;break}}this.h=C,this.o+=m},r.prototype.v=function(){var _=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);_[0]=128;for(var m=1;m<_.length-8;++m)_[m]=0;var v=8*this.o;for(m=_.length-8;m<_.length;++m)_[m]=v&255,v/=256;for(this.u(_),_=Array(16),m=v=0;4>m;++m)for(var w=0;32>w;w+=8)_[v++]=this.g[m]>>>w&255;return _};function s(_,m){var v=l;return Object.prototype.hasOwnProperty.call(v,_)?v[_]:v[_]=m(_)}function o(_,m){this.h=m;for(var v=[],w=!0,C=_.length-1;0<=C;C--){var k=_[C]|0;w&&k==m||(v[C]=k,w=!1)}this.g=v}var l={};function u(_){return-128<=_&&128>_?s(_,function(m){return new o([m|0],0>m?-1:0)}):new o([_|0],0>_?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return g;if(0>_)return V(h(-_));for(var m=[],v=1,w=0;_>=v;w++)m[w]=_/v|0,v*=4294967296;return new o(m,0)}function f(_,m){if(_.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(_.charAt(0)=="-")return V(f(_.substring(1),m));if(0<=_.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(m,8)),w=g,C=0;C<_.length;C+=8){var k=Math.min(8,_.length-C),A=parseInt(_.substring(C,C+k),m);8>k?(k=h(Math.pow(m,k)),w=w.j(k).add(h(A))):(w=w.j(v),w=w.add(h(A)))}return w}var g=u(0),y=u(1),T=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-V(this).m();for(var _=0,m=1,v=0;v<this.g.length;v++){var w=this.i(v);_+=(0<=w?w:4294967296+w)*m,m*=4294967296}return _},t.toString=function(_){if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(P(this))return"0";if(N(this))return"-"+V(this).toString(_);for(var m=h(Math.pow(_,6)),v=this,w="";;){var C=D(v,m).g;v=I(v,C.j(m));var k=((0<v.g.length?v.g[0]:v.h)>>>0).toString(_);if(v=C,P(v))return k+w;for(;6>k.length;)k="0"+k;w=k+w}},t.i=function(_){return 0>_?0:_<this.g.length?this.g[_]:this.h};function P(_){if(_.h!=0)return!1;for(var m=0;m<_.g.length;m++)if(_.g[m]!=0)return!1;return!0}function N(_){return _.h==-1}t.l=function(_){return _=I(this,_),N(_)?-1:P(_)?0:1};function V(_){for(var m=_.g.length,v=[],w=0;w<m;w++)v[w]=~_.g[w];return new o(v,~_.h).add(y)}t.abs=function(){return N(this)?V(this):this},t.add=function(_){for(var m=Math.max(this.g.length,_.g.length),v=[],w=0,C=0;C<=m;C++){var k=w+(this.i(C)&65535)+(_.i(C)&65535),A=(k>>>16)+(this.i(C)>>>16)+(_.i(C)>>>16);w=A>>>16,k&=65535,A&=65535,v[C]=A<<16|k}return new o(v,v[v.length-1]&-2147483648?-1:0)};function I(_,m){return _.add(V(m))}t.j=function(_){if(P(this)||P(_))return g;if(N(this))return N(_)?V(this).j(V(_)):V(V(this).j(_));if(N(_))return V(this.j(V(_)));if(0>this.l(T)&&0>_.l(T))return h(this.m()*_.m());for(var m=this.g.length+_.g.length,v=[],w=0;w<2*m;w++)v[w]=0;for(w=0;w<this.g.length;w++)for(var C=0;C<_.g.length;C++){var k=this.i(w)>>>16,A=this.i(w)&65535,dt=_.i(C)>>>16,Ce=_.i(C)&65535;v[2*w+2*C]+=A*Ce,E(v,2*w+2*C),v[2*w+2*C+1]+=k*Ce,E(v,2*w+2*C+1),v[2*w+2*C+1]+=A*dt,E(v,2*w+2*C+1),v[2*w+2*C+2]+=k*dt,E(v,2*w+2*C+2)}for(w=0;w<m;w++)v[w]=v[2*w+1]<<16|v[2*w];for(w=m;w<2*m;w++)v[w]=0;return new o(v,0)};function E(_,m){for(;(_[m]&65535)!=_[m];)_[m+1]+=_[m]>>>16,_[m]&=65535,m++}function S(_,m){this.g=_,this.h=m}function D(_,m){if(P(m))throw Error("division by zero");if(P(_))return new S(g,g);if(N(_))return m=D(V(_),m),new S(V(m.g),V(m.h));if(N(m))return m=D(_,V(m)),new S(V(m.g),m.h);if(30<_.g.length){if(N(_)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var v=y,w=m;0>=w.l(_);)v=B(v),w=B(w);var C=F(v,1),k=F(w,1);for(w=F(w,2),v=F(v,2);!P(w);){var A=k.add(w);0>=A.l(_)&&(C=C.add(v),k=A),w=F(w,1),v=F(v,1)}return m=I(_,C.j(m)),new S(C,m)}for(C=g;0<=_.l(m);){for(v=Math.max(1,Math.floor(_.m()/m.m())),w=Math.ceil(Math.log(v)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),k=h(v),A=k.j(m);N(A)||0<A.l(_);)v-=w,k=h(v),A=k.j(m);P(k)&&(k=y),C=C.add(k),_=I(_,A)}return new S(C,_)}t.A=function(_){return D(this,_).h},t.and=function(_){for(var m=Math.max(this.g.length,_.g.length),v=[],w=0;w<m;w++)v[w]=this.i(w)&_.i(w);return new o(v,this.h&_.h)},t.or=function(_){for(var m=Math.max(this.g.length,_.g.length),v=[],w=0;w<m;w++)v[w]=this.i(w)|_.i(w);return new o(v,this.h|_.h)},t.xor=function(_){for(var m=Math.max(this.g.length,_.g.length),v=[],w=0;w<m;w++)v[w]=this.i(w)^_.i(w);return new o(v,this.h^_.h)};function B(_){for(var m=_.g.length+1,v=[],w=0;w<m;w++)v[w]=_.i(w)<<1|_.i(w-1)>>>31;return new o(v,_.h)}function F(_,m){var v=m>>5;m%=32;for(var w=_.g.length-v,C=[],k=0;k<w;k++)C[k]=0<m?_.i(k+v)>>>m|_.i(k+v+1)<<32-m:_.i(k+v);return new o(C,_.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,pE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,kr=o}).apply(typeof ig<"u"?ig:typeof self<"u"?self:typeof window<"u"?window:{});var Ia=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
